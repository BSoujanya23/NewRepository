...
public class ToCreateOrgWithIndustryAndTypeTest extends BaseClass {
	...
	public void toCreateOrgWithIndustryAndTypeTest_TC_004() throws EncryptedDocumentException, IOException {
		...
		String ORGNAME = eutil.toReadDataFromExcelFile("Organization", 9, 2);
		String INDUSTRYNAME = eutil.toReadDataFromExcelFile("Organization", 9, 3);
		String TYPE = eutil.toReadDataFromExcelFile("Organization", 9, 4);
		...
		wutil.toHandleDropdown(cop.getTypeDropdown(), TYPE);
